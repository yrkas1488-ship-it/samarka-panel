...
import SuperMasterModal from './SuperMasterModal';
      ...
      <Layout className={pageClass}>
                  ...
                  <Col span={24}>
                    <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 12 }}>
                      <Button
                        type="primary"
                        icon={<CrownOutlined />}
                        style={{ background: '#faad14', borderColor: '#d48806' }}
                        onClick={() => setSuperMasterOpen(true)}
                      >
                        👑 Кластер: Глав-Главный и Ссылки для нод
                      </Button>
                    </div>
                    <NodeList
                      nodes={nodes}
        ...
        <SuperMasterModal
          ...
          onAddSubordinate={(link) => {
            ...
            setFormNode(null);
            setFormOpen(true);
            messageApi.info('Вставьте скопированную ссылку в поле "⚡ Вставить ссылку" в открывшемся окне');
          }}
        />
