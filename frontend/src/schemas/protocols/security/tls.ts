...
export const TlsClientSettingsSchema = z.object({
  fingerprint: TlsFingerprintSchema.default('randomized'),
...
export const TlsStreamSettingsSchema = z.object({
  ...
  settings: TlsClientSettingsSchema.default({ fingerprint: 'randomized', echConfigList: '', pinnedPeerCertSha256: [], verifyPeerCertByName: '' }),
});
