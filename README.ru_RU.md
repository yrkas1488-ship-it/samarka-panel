...
- **Привязка собственного домена к панели**: руководство по DNS A-записям, Let's Encrypt Certbot, Nginx reverse proxy и кнопка прямого перехода в Cloudflare.
